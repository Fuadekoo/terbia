  ...
  return (
    ...
    >
      {!chatId && (
        ...
        >
          <div
            style={{ fontWeight: 700, marginBottom: 6, color: getTextColor() }}
          >
            Open in Telegram
          </div>
                ...
                >
                  ...
                  <Image
                    ...
                    style={{
                      borderRadius: "50%",
                      objectFit: "cover",
                      border: `3px solid ${getButtonTextColor()}4d`,
                      flexShrink: 0,
                    }}
                  />
                  {/* Student Info */}
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      {chooseData.students[0].name || "Student"}
                    </div>
                    <div
                      style={{ fontSize: 14, opacity: 0.9, marginBottom: 8 }}
                    >
                      <span>
                        {chooseData.students[0].packages.length}{" "}
                        {chooseData.students[0].packages.length === 1
                          ? "package"
                          : "packages"}
                      </span>
                    ...
                    <div style={{ fontSize: 13, opacity: 0.85 }}>
                      Teacher:{" "}
                      {chooseData.students[0].teacherName || "Not assigned"}
                    </div>
                  </div>
                </div>
              </div>
