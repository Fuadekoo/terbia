...
import { chooseStudentPackage, getStudentFlowById } from '@/actions/student/telegram';
                ...
                {chooseData.students.map((s) => (
                  ...
                  >
                    <Image
                      ...
                      width={120}
                      height={120}
                      style={{ borderRadius: '50%', objectFit: 'cover', border: `4px solid ${getLinkColor()}`, boxShadow: `0 10px 24px ${getLinkColor()}40`, display: 'block', margin: '0 auto', background: getSecondaryBgColor() || '#e0f2fe' }}
                    />
                ...
                {chooseData.students[0].packages.map((pkg) => (
                  <div key={pkg.id} style={{ background: getSecondaryBgColor() || '#ffffff', border: `1px solid ${getSecondaryBgColor()}`, borderRadius: 14, overflow: 'hidden', boxShadow: '0 10px 24px rgba(0,0,0,0.08)' }}>
                    <div style={{ height: 140, position: 'relative' }}>
                      <Image src="/quranlogo.png" alt="Package thumbnail" fill style={{ objectFit: 'cover' }} />
