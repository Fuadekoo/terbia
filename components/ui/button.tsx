  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground hover:border-primary/40 dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
